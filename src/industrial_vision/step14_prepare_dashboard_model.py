"""Step 14 command script: prepare model for the inspection dashboard."""
...
def main() -> None:
    """Create dataset, train model, and save model artifact for the dashboard."""

    ensure_project_directories()

    dataset_dir = SAMPLE_IMAGES_DIR / "step10_ml_dataset"
    output_dir = PREDICTIONS_OUTPUT_DIR / "step12_model_persistence"
    feature_csv_path = output_dir / "step14_dashboard_training_features.csv"
    ...
    print("Step 14 — Prepare Model for Simple Inspection Dashboard")
